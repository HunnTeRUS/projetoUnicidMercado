...
<div id="logo" class="container">
	<h1><a href="#" class="icon icon-shopping-cart"><span>Listagem de Categorias</span></a></h1>
</div>
	   ...
	   <table>
		...
		<c:forEach items="${jspCategorias}" var="categorias">
			<tr>
				...
				<td><a href="${pageContext.request.contextPath}/list-categorias-byid?id=${categorias.id}">Alterar</a></td>
				<td><a href="${pageContext.request.contextPath}/delete-categorias?id=${categorias.id}">Excluir</a></td>
			</tr>
		</c:forEach>
	</table>
